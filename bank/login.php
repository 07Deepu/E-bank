...
<h1 class="alert alert-success rounded-0"><?php echo 'bankname'; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:DEEPU SAHOO</kbd></small></h1>
<br>
