...
<body>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- Uncomment below if you prefer to use an text logo -->
         <h1><a href="index.php">E BANK</a></h1> 
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Welcome to the<br><span>E Bank</span><br>Services!</h2>
        <div>
          <a href=bank/login.php class="btn-get-started scrollto">Employ Login</a>
          <!-- <a href="forms/manager-login.php" class="btn-services scrollto">Cashier Login</a> -->
        </div>
      </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Near Z.P. School<br>
              Tunki Bk. 435264 <br>
              <strong>Phone:</strong> +919583568580<br>
              <strong>Email:</strong> deepusahoo97@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2021 Copyright <strong> DEEPU SAHOO </strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
